...
if(isset($_POST['ok']))
{
	...
	$sub = $_POST['subject'];
	$msg = $_POST['message'];
	$query = "insert into query (name,subject,message) values('$nm','$sub','$msg')";
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">Junagadh, Gujrat, India</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">studyinfo@gmail.com</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 wow fadeInUp">
                    <form action="" method="post">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit" name="ok">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
